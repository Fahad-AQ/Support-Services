                ...
                <form id="add_employee">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="number" name="emp_adpId" class="form-control border-info required_colom" value="<?php echo count($employees)+1 ;?>" required="required" id="name">
                    </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                        <label for="activeStatus">Employee Type:</label>
  ...
  var add_employee = $('#add_employee');  
    add_employee.on('submit',function(e){
      ...
      if(assetserror > 0){return false;}else{
        $.ajax({
          type:'POST',
          url:'<?php echo base_url('sAdmin/add_employeeForm'); ?>',
          data:new_prd_add,
          dataType:'JSON',
