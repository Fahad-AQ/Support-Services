...
<body class="light_theme  fixed_header left_nav_fixed">
	<div class="wrapper">
		<div class="header_bar">
			<div class="brand">
			  <div class="logo" style="display:block"><span class="theme_color"></span>Inventory-Accessories</div>
					...
					<div class="top_right_bar">
						<div class="user_admin dropdown"> 
							<a href="javascript:void(0);" data-toggle="dropdown">
								<img style="width: 45px;border-radius: 100%;" src="<?php echo $this->session->userdata('photo'); ?>" class="profile-img" />
								<span>&nbsp;<?php echo $this->session->userdata('name'); ?>&nbsp;(<?php echo $this->session->userdata('role'); ?>)
								</span><b class="caret"></b>
							 </a>
						  <ul class="dropdown-menu animated rubberBand">
							<div class="top_pointer"></div>
								<li>
									 <a href="<?php echo base_url('inventoryAccessories/admin/logout'); ?>"><i class="fa fa-power-off"></i> Logout</a> 
								 </li>
						   </ul>
						</div>
			         </div>
...
<?php $this->load->view('admin/inventoryAccessories/nav'); ?>