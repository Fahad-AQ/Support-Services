        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel default blue_title h2">
              <div class="panel-heading">Declined Order List</div>
              <div class="panel-body">
               <form class="form-group text-right" action="<?php echo base_url('inventoryAccessories/admin/inventoryAccessories_declinedOrdersExportExcel') ?>" method="post" id="exportOrders" enctype="multipart/form-data">
                    <b>Note :</b> Only Declined Orders Export &nbsp; <button type="submit" name="Export" class="btn btn-primary"><i class="fa fa-download add-tooltip"></i> &nbsp; Export to Excel</button>
               ...
               <table  class="display table table-bordered table-striped" id="dynamic-table"  style="overflow-x:auto;">
                  ...
                  <?php 
                   if($orders) {
                     $i=0;
                    foreach ($orders as $order) {if ($order['status_id'] == 4 ){
                       $i++;
                     ?>
                          <tr>
                          <td><?php echo $i;?></td>
