        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel default blue_title h2">
              <div class="panel-heading">Declined Orders List</div>
              <div class="panel-body">
               <form class="form-group text-right" action="<?php echo base_url('storeSupplies/admin/storeSupplies_declinedOrdersExportExcel') ?>" method="post" id="exportOrders" enctype="multipart/form-data">
