...
<div class="wrapper">
  ...
  <?php echo form_open(base_url(''),array('class'=>"form-horizontal", 'id'=>'selectCategory')); ?>
   ...
   <div class="content-group-lg">
     <img style="width: 70%;" src="<?php echo base_url(); ?>assets/images/support_icon.png" /><br/><div class="message alert alert-styled-left"></div>
    </div>
  ...
  var selectCategory = $('#selectCategory');  
    selectCategory.on('submit',function(e){
      ...
      if(assetserror > 0){return false;}else{
        $.ajax({
          type:'POST',
          url:'<?php echo base_url('admin/setCatergory'); ?>',
          data:new_prd_add,
          dataType:'JSON',
