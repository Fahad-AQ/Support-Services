...
<body class="light_theme  fixed_header left_nav_fixed">
	<div class="wrapper">
		<div class="header_bar">
			<div class="brand">
			  <div class="logo" style="display:block"><span class="theme_color"></span>Discount Log</div>
    ...
    border-radius: 100%;" src="<?php echo $this->session->userdata('photo'); ?>" class="profile-img" /><span class="user_adminname"><?php echo $this->session->userdata('name'); ?> </span><b class="caret"></b> </a>
				  <ul class="dropdown-menu animated rubberBand">
					<div class="top_pointer"></div>
					<li> <a href="<?php echo base_url('discountLog/admin/logout'); ?>"><i class="fa fa-power-off"></i> Logout</a> </li>
				  </ul>
				</div>
			  </div>
			</div>
		...
		<?php $this->load->view('admin/discountLog/nav'); ?>