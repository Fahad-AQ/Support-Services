  ...
  <div class="inner">
    <div class="contentpanel">
     ...
     <!--  <div class="row">
      ...
      <form class="form-group text-right" action="<?php echo base_url('discountLog/admin/completedDiscountLog_ordersExportExcel') ?>" method="post" id="exportOrders" enctype="multipart/form-data">
                   <b>Note :</b> Only Complete Discount Request Export &nbsp;   <button type="submit" name="Export" class="btn btn-primary"><i class="fa fa-download add-tooltip"></i> &nbsp; Export to Excel</button>
    ...
    <script >
      $.ajax({
    type: 'GET',
    url: '<?php echo base_url('discountLog/admin/discountChart');?>',  
    dataType: 'json',
    success: function (data){
          ...
          title: {
              text: 'Complete Discount Requests'
            },
            subtitle: {
              text: 'All Monthly Wise Complete Discount Requests'
            },
            plotOptions: {
              column: {
                depth: 25
