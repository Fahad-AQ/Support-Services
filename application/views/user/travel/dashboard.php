                 ...
                 <?php 
                   if($orders) {
                    foreach ($orders as $order){
                      if($this->session->userdata('roleId') == 2 && $order['sd_email'] == $this->session->userdata('email')||$this->session->userdata('roleId') == 2 && $order['emp_email'] == $this->session->userdata('email')){
                     ?>
                      <tr>
                      ...
                      else if($this->session->userdata('roleId') == 3 && $order['tm_email'] == $this->session->userdata('email')||$this->session->userdata('roleId') == 3 && $order['emp_email'] == $this->session->userdata('email')){
                        ?>
                      <tr>
                      <td><?php echo $order['order_id'];?></td>
                      <td><?php echo $order['order_date'];?></td>
                      ...
                      else if($this->session->userdata('roleId') == 4 && $order['cm_email'] == $this->session->userdata('email')||$this->session->userdata('roleId') == 4 && $order['emp_email'] == $this->session->userdata('email')){
                        ?>
                        <tr>
                        <td><?php echo $order['order_id'];?></td>
                        <td><?php echo $order['order_date'];?></td>
