<div class="left_nav">
      ...
      <div class="left_nav_slidebar">
        <ul>
          <li class="<?php if($this->uri->segment(2) == 'travel_dashboard'){echo "left_nav_active theme_border";} ?>"><a class="<?php if($this->uri->segment(2) == 'travel_dashboard'){echo "active";} ?>" href="<?php echo base_url('user/travel_dashboard'); ?>"> <i class="fa fa-dashboard animated-hover faa-wrench"></i> DASHBOARD <span class="plus"></span></a>
