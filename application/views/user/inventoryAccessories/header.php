...
<body class="light_theme  fixed_header left_nav_fixed">
    ...
    border-radius: 100%;"  src="<?php echo $this->session->userdata('photo'); ?>" class="profile-img" />&nbsp;<?php echo $this->session->userdata('name'); ?>&nbsp;(<?php echo $this->session->userdata('role'); ?>)<b class="caret"></b> </a>
				  <ul class="dropdown-menu animated rubberBand">
					<div class="top_pointer"></div>
					<li> <a href="<?php echo base_url('inventoryAccessories/user/logout'); ?>"><i class="fa fa-power-off"></i> Logout</a> </li>
				  </ul>
				</div>
			  </div>
			</div>
		...
		<?php $this->load->view('user/inventoryAccessories/nav'); ?>