<?php
class DiscountLog_User_m extends CI_Model {
	...
	public function check_order_exist($storeId){
	    ...
	    $userStore = $storeId;
	    $results = $this->db->query("SELECT * FROM orders WHERE store_id ='$userStore' AND status_id = 1  OR store_id ='$userStore' AND  status_id = 2  OR store_id ='$userStore' AND  Month(order_date) = '$month' ");
	    if($results->num_rows() > 0){
			return true;
		}
		else{
