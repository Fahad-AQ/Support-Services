...
-- Generation Time: Aug 04, 2017 at 11:36 AM
-- Server version: 1.0.123
-- PHP Version: 5.2.13
...
CREATE TABLE IF NOT EXISTS `cm` (
  `cm_id` int(50) NOT NULL AUTO_INCREMENT,
  `cm_name` varchar(250) NOT NULL,
  `cm_email` varchar(250) NOT NULL,
  PRIMARY KEY (`cm_id`),
  UNIQUE KEY `cm_email` (`cm_email`)
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  KEY `emp_roleId` (`role_id`),
  KEY `emp_storeId` (`store_id`),
  KEY `sd_id` (`sd_id`),
  KEY `tm_id` (`tm_id`),
  KEY `cm_id` (`cm_id`)
...
(2, 1, 1, 1, 'Muhammad Shabbir', 'muhammad_shabbir@mobilelinkusa.com', 'https://lh6.googleusercontent.com/-3IMdWSbjLh8/AAAAAAAAAAI/AAAAAAAAA00/LfabxYvprfs/s96-c/photo.jpg', 123232, 5, 377, '1'),
...
(5, 1, 1, 1, 'Farhan Nasim', 'nasim_farhan@mobilelinkusa.com', 'https://lh4.googleusercontent.com/-VhSA6rx8O9k/AAAAAAAAAAI/AAAAAAAAAAo/hTa3mjo2EJk/s96-c/photo.jpg', 6532, 5, 376, '1'),
(6, 1, 2, 1, 'Noman Ansari', 'noman_ansari@mobilelinkusa.com', 'https://lh3.googleusercontent.com/-Hs-RLTdzHrY/AAAAAAAAAAI/AAAAAAAAAAA/AMp5VUqLbA0I1Cl5rH2AiwiUFb9HNomqfg/s96-c/photo.jpg', 235650, 3, 378, '1');
...
CREATE TABLE IF NOT EXISTS `financestatus` (
  `financestatus_id` int(50) NOT NULL AUTO_INCREMENT,
  `financestatus_name` varchar(250) NOT NULL,
  PRIMARY KEY (`financestatus_id`)
...
CREATE TABLE IF NOT EXISTS `markets` (
  `market_id` int(50) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `orderdetails` (
  `orderdetails_id` int(50) NOT NULL AUTO_INCREMENT,
  ...
  KEY `orders_prdId` (`product_id`),
  KEY `orders_financeStatusId` (`financestatus_id`),
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  KEY `od_userId` (`emp_id`),
  KEY `od_status` (`status_id`),
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  UNIQUE KEY `prd_name` (`product_name`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `sd` (
  `sd_id` int(50) NOT NULL AUTO_INCREMENT,
  `sd_name` varchar(250) NOT NULL,
  `sd_email` varchar(250) NOT NULL,
  PRIMARY KEY (`sd_id`),
  UNIQUE KEY `sd_email` (`sd_email`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `stores` (
  ...
  UNIQUE KEY `store_uId` (`store_uId`),
